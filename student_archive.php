...
$stmt = $pdo->prepare('UPDATE students SET status = "Inactive", qr_token = :qr_token WHERE student_id = :id');
$stmt->execute([':qr_token' => generate_qr_token(), ':id' => $id]);

redirect('students.php?archived=1');
